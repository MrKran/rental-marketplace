...
export function ProfilePage({ 
  ...
  const achievements = [
    { id: 1, name: "Первая сделка", description: "Успешно завершили первую аренду", earned: false },
    { id: 2, name: "Надежный партнер", description: "10+ успешных сделок", earned: false },
    { id: 3, name: "Популярный арендодатель", description: "100+ просмотров профиля", earned: false },
    { id: 4, name: "Эксперт", description: "Рейтинг выше 4.5", earned: false },
